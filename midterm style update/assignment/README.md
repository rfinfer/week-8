...
PROBLEMS->
zoom isn't being reset on p 1
add all layers back in for last slide??
remove death isn't working backwards

to do->
- hide previous button on first page
- style.
-code up final legend in css (final one). position it. use
.html method inside anchor. to set html of div
copy and paste html into each slide and edit it slightly
